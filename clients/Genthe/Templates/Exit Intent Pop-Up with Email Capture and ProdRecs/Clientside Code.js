(function() {
     ...
     */
    function setConfirmationPanel() {
        Evergage.cashDom("#evg-exit-intent-btn").on("click", () => {
    ...
    function apply(context, template) {
        ...
        return Evergage.DisplayUtils
            ...
            .then(() => {
                ...
                document.getElementById("evg-exit-intent-email").focus();
            });
    }
    ...
    function reset(context, template) {
        ...
        Evergage.cashDom("#evg-exit-intent-popup-email-capture").remove();
        // Einstein recommendations start
    ...
    function control(context) {
        return Evergage.DisplayUtils
            ...
            .then(() => {
                ...
                // Einstein recommendations content end.
