(function() {
    ...
    function apply(context, template) {
        const contentZoneSelector = Evergage.getContentZoneSelector(context.contentZone);//'.nm-banner-slider .slick-list .nm-banner-slide'
        ...
        return Evergage.DisplayUtils
            ...
            .then((element) => {
                ...
                Evergage.cashDom(element).find('img').attr('src', html);
